...
namespace Sandbox_Games
{
    public class ParticleForce
    {
        ...
        public virtual void Draw(GameTime gameTime)
        {
            ...
            byte newColorValue = (byte)(255 - 255 * (velocity / maxVelocity).Length()* 0.5f);
    ...
    public class ParticleBase : DrawableGameComponent
    {
        public Game_Base myGame;
    ...
    public class ParticleGenerator : ParticleBase
    {
        List<ParticleForce> particleList;
        ...
        public void SpawnParticles(int num)
        {
            for (int i = 0; i < num; i++)
            {
                ParticleForce newParticle = new ParticleForce(this);
    ...
    public class ParticleModifier : ParticleBase
    {
        public float force;
    ...
    {
        public ParticleAttractor(Game_Base game, Vector2 inPosition) :
            base(game, inPosition)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            myColor.A = 128;
            myGame.spriteBatch.Begin();
            myGame.spriteBatch.Draw(mySprite, position, new Rectangle(0, 0, mySprite.Width, mySprite.Height), myColor, 0.0f, new Vector2(mySprite.Width / 2.0f, mySprite.Height / 2.0f), drawScale, SpriteEffects.None, 0.0f);
            myGame.spriteBatch.End();
        }
    }
