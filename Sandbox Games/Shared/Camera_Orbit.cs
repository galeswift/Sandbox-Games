...
namespace Sandbox_Games
{
    ...
    /// </summary>
    public class Camera_Orbit : Camera_Base
    {
        ...
        /// </summary>
        public Camera_Orbit(Game inGame, Viewport inViewport, SampleArcBallCameraMode controlMode) : 
            base( inGame, inViewport )
        {
        ...
        protected override void CalcViewMatrix(GameTime gameTime)
        {                       
            _viewMatrix = Matrix.CreateLookAt(targetValue - (Direction * distanceValue), targetValue, Up);
        }
        #endregion
    }
