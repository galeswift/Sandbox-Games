// Xen.Graphics.ShaderSystem.Native.h
...
namespace Native
{
	...
	public:
		...
		ShaderDecompiler(array<Byte> ^ fileContents, String ^ fileName, bool xbox, IEffectCallback ^ callback)
		{
			...
			D3DXMACRO macros[3];
			macros[0].Name = xbox ? "XBOX360" : "WINDOWS";
			macros[0].Definition = "1";
			macros[1].Name = xbox ? "XBOX" : NULL;
			macros[1].Definition = xbox ? "1" : NULL;
			macros[2].Name = NULL;
