...
namespace Xen
{
	...
	public sealed partial class UpdateState : IState
	{
		...
		internal UpdateState(Application application, PlayerInputCollection input, GamePadState[] pads)
		{
	...
	sealed partial class AppState : IState, IUpdate
	{
		...
		internal AppState(Application game)
		{
			...
			this.updateState = new UpdateState(this.application, this.playerInputCollection, this.pads);
		}
