...
namespace Xen
{
	...
	/// </summary>
	internal sealed class XnaDrawableGameComponentWrapper : Microsoft.Xna.Framework.GameComponent, IDraw
	{
		private readonly Microsoft.Xna.Framework.DrawableGameComponent component;
		...
		public Microsoft.Xna.Framework.DrawableGameComponent Component { get { return component; } }
		...
		void OnUpdateOrderChangedHandler(object sender, EventArgs e)
		{
	...
	public static class XnaExtensions
	{
		...
		/// </summary>
		public static void Draw(this Microsoft.Xna.Framework.DrawableGameComponent component, DrawState state)
		{
#if DEBUG
		...
		/// [XEN EXTENSION] Draw an XNA drawable game component
		/// </summary>
		public static void Draw(this Microsoft.Xna.Framework.DrawableGameComponent component, FrameState farme)
		{
		...
		/// </summary>
		public static void Update(this Microsoft.Xna.Framework.GameComponent component, UpdateState state)
		{
