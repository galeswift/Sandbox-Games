...
namespace Xen.Input.Mapping
{
	...
	/// <remarks>
	/// <para>
	/// This class can be implicitly cast from a MouseInput enumeration and <see cref="Keys"/> enumeration
	/// </para>
	/// <para>eg:</para>
	/// <example>
	/// <code>
	...
	public sealed class KeyboardMouseControlMapping
	{
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right trigger
		/// </summary>
#endif
...
#if !XBOX360
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> or <see cref="Mouse"/> mapping for the left trigger (default is <see cref="MouseInput.LeftButton"/>)
		/// </summary>
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left trigger
		/// </summary>
#endif
		...
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right stick click button (default is <see cref="Keys.R"/>)
		/// </summary>
		...
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left stick click button (default is <see cref="Keys.Q"/>)
		/// </summary>
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left stick's right direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left stick's left direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left stick's backwards direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the left stick's forwards direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right stick's right direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right stick's left direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right stick's backwards direction
		/// </summary>
#endif
...
#else
		/// <summary>
		/// Gets/Sets the <see cref="Keys"/> mapping for the right stick's forwards direction
		/// </summary>
#endif
