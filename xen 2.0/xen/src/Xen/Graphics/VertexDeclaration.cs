...
namespace Xen.Graphics
{
	...
	class VertexDeclarationBuilder
	{
		...
		[System.Diagnostics.DebuggerStepThrough]
#endif
		class DeclarationHash : IComparable<DeclarationHash>
		{
		...
		class ElementHash : IComparable<ElementHash>
		{
			int hash;
		...
		void ValidateDevice(GraphicsDevice device)
		{
		...
		static VertexElementFormat DetermineFormat(FieldInfo field)
		{
