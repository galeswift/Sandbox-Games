...
namespace Xen.Graphics
{
	...
	public abstract class DrawTarget : Resource, IFrameDraw
	{
		...
		/// </summary>
		public void Add(Microsoft.Xna.Framework.DrawableGameComponent xnaComponent, Application application)
		{
		...
		/// <para>Note: The DrawableGameComponent must not modify the current render target!</para>
		/// </summary>
		public void Insert(int index, Microsoft.Xna.Framework.DrawableGameComponent xnaComponent, Application application)
		{
		...
		/// </summary>
		/// <returns>true if the item was removed</returns>
		public bool Remove(Microsoft.Xna.Framework.DrawableGameComponent xnaComponent)
		{
	...
	public sealed class DrawTargetScreen : DrawTarget
	{
		...
		public DrawTargetScreen(ICamera camera) : base(camera)
		{
	...
	public sealed class DrawTargetTexture2DGroup : DrawTarget, IDisposable
	{
		...
		public static int MaxSimultaneousRenderTargets
		{
			get
			{
				return GraphicsAdapter.DefaultAdapter.IsProfileSupported(GraphicsProfile.HiDef) ? 4 : 1;
			}
		}
	...
	public sealed class DrawTargetTextureCube : DrawTarget, IDisposable, IContentOwner
	{
		...
		public static bool SupportsFormat(ref SurfaceFormat format)
		{
			return DrawTargetTexture2D.SupportsFormat(ref format);
		}
