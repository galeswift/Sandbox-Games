...
namespace Xen.Graphics.Stack
{
	...
	public sealed class DeviceRenderStateStack
	{
		...
		internal void ApplyRenderStateChanges(int vertexCount, Xen.Graphics.AnimationTransformArray blendTransforms, Xen.Graphics.ShaderSystem.ShaderExtension extension)
		{
		...
		{
			ApplyRenderStateChanges(0, null, Xen.Graphics.ShaderSystem.ShaderExtension.None);
		}
