...
namespace Tutorials.Tutorial_28
{
	...
	class RenderConfiguration
	{
		...
		public RenderConfiguration(Tutorial tutorial) { this.tutorial = tutorial; }
		...
		public bool HalfLensExposure				{ set { tutorial.ScaleExposure(0.5f); } }
		public bool DoubleLensExposure				{ set { tutorial.ScaleExposure(2); } }
		public bool ChangeScene						{ set { tutorial.ChangeScene(); } }
	}
	...
	class RenderConfigEditor : IDraw, IUpdate, IContentOwner
	{
		...
		public UpdateFrequency Update(UpdateState state)
		{
			...
			{
				if (state.PlayerInput[0].InputState.Buttons.DpadDown.IsPressedRepeats(state, 0.1f, 0.15f))
					this.editSelection--;
				if (state.PlayerInput[0].InputState.Buttons.DpadUp.IsPressedRepeats(state, 0.1f, 0.15f))
					this.editSelection++;
